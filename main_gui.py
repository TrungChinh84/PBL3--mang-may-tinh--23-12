...
class FirewallGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Firewall Management System - PBL3")
    ...
    def setup_dashboard_tab(self):
        ...
        # --- Quick actions (Chỉ giữ lại một bản ở đầu) ---
    ...
    def setup_status_bar(self):
        ...
        ttk.Label(frame, text="PBL3 - Linux Firewall System").pack(side=tk.RIGHT, padx=5)
    ...
    def check_services(self):
        services = {
            ...
            # Đã xóa Fail2Ban khỏi danh sách kiểm tra
            'iptables': 'IPTables'
        }
        status_text = ""
    ...
    def refresh_all(self):
        ...
        # Đã xóa phần refresh Fail2Ban

        # 3. Refresh Firewall Tab (IPTables Rules)
